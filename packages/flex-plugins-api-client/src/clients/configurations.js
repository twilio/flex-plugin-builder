 ...
 */
var ConfigurationsClient = /** @class */ (function () {
    function ConfigurationsClient(client) {
        this.client = client;
    }
    /**
     ...
     */
    ConfigurationsClient.getUrl = function (configId) {
        if (configId) {
     ...
     */
    ConfigurationsClient.prototype.list = function (pagination) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.list(ConfigurationsClient.getUrl(), RESPONSE_KEY, pagination)];
            });
        });
    };
    /**
     ...
     */
    ConfigurationsClient.prototype.latest = function () {
        return __awaiter(this, void 0, void 0, function () {
            var list;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        list = _a.sent();
                        return [2 /*return*/, list.configurations[0]];
                }
            });
        });
    };
     ...
     * @param configId  the configuration identifier
     */
    ConfigurationsClient.prototype.get = function (configId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.get(ConfigurationsClient.getUrl(configId), { cacheable: true })];
            });
        });
    };
    /**
     ...
     */
    ConfigurationsClient.prototype.create = function (object) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.post(ConfigurationsClient.getUrl(), object)];
            });
        });
    };
    /**
    ...
    ConfigurationsClient.prototype.archive = function (configId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.client.post(url_join_1.default(ConfigurationsClient.getUrl(configId), 'Archive'), {})];
            });
        });
    };
    return ConfigurationsClient;
}());
exports.default = ConfigurationsClient;
