 ...
 */
var FlexPluginsDescribePlugin = /** @class */ (function (_super) {
    __extends(FlexPluginsDescribePlugin, _super);
    function FlexPluginsDescribePlugin() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * @override
     */
    FlexPluginsDescribePlugin.prototype.getResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.pluginsApiToolkit.describePlugin({ name: this._flags.name })];
            });
        });
    };
    /**
    ...
    FlexPluginsDescribePlugin.prototype.notFound = function () {
     ...
     */
    /* istanbul ignore next */
    FlexPluginsDescribePlugin.prototype.print = function (plugin) {
        var _this = this;
        ...
        this.sortByActive(plugin.versions).forEach(function (version) {
            var isActive = version.isActive ? '(Active)' : '';
            _this.printVersion(version.version, isActive);
            _this.printPretty(version, 'isActive');
            _this._logger.newline();
        });
    };
    Object.defineProperty(FlexPluginsDescribePlugin.prototype, "_flags", {
        /**
    ...
    FlexPluginsDescribePlugin.flags = __assign(__assign({}, flex_plugin_1.default.flags), { name: command_1.flags.string({
            description: FlexPluginsDescribePlugin.topic.flags.name,
            required: true,
        }) });
    return FlexPluginsDescribePlugin;
