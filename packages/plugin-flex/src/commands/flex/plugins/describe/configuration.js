 ...
 */
var FlexPluginsDescribeConfiguration = /** @class */ (function (_super) {
    __extends(FlexPluginsDescribeConfiguration, _super);
    function FlexPluginsDescribeConfiguration() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * @override
     */
    FlexPluginsDescribeConfiguration.prototype.getResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.pluginsApiToolkit.describeConfiguration({ sid: this._flags.sid })];
            });
        });
    };
    /**
    ...
    FlexPluginsDescribeConfiguration.prototype.notFound = function () {
     ...
     */
    /* istanbul ignore next */
    FlexPluginsDescribeConfiguration.prototype.print = function (configuration) {
        var _this = this;
        ...
        configuration.plugins.forEach(function (plugin) {
            _this.printVersion(plugin.name);
            _this.printPretty(plugin, 'version', 'name');
            _this._logger.newline();
        });
    };
    Object.defineProperty(FlexPluginsDescribeConfiguration.prototype, "_flags", {
        /**
    ...
    FlexPluginsDescribeConfiguration.flags = __assign(__assign({}, flex_plugin_1.default.flags), { sid: command_1.flags.string({
            description: FlexPluginsDescribeConfiguration.topic.flags.sid,
            required: true,
        }) });
    return FlexPluginsDescribeConfiguration;
