 ...
 */
var FlexPluginsDescribePluginVersion = /** @class */ (function (_super) {
    __extends(FlexPluginsDescribePluginVersion, _super);
    function FlexPluginsDescribePluginVersion() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * @override
     */
    FlexPluginsDescribePluginVersion.prototype.getResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, name, version;
            return __generator(this, function (_b) {
                _a = this._flags, name = _a.name, version = _a.version;
                return [2 /*return*/, this.pluginsApiToolkit.describePluginVersion({ name: name, version: version })];
            });
        });
    };
    /**
    ...
    FlexPluginsDescribePluginVersion.prototype.notFound = function () {
        var _a = this._flags, name = _a.name, version = _a.version;
     ...
     */
    /* istanbul ignore next */
    FlexPluginsDescribePluginVersion.prototype.print = function (version) {
    ...
    Object.defineProperty(FlexPluginsDescribePluginVersion.prototype, "_flags", {
        /**
    ...
    FlexPluginsDescribePluginVersion.flags = __assign(__assign({}, flex_plugin_1.default.flags), { name: command_1.flags.string({
    ...
    return FlexPluginsDescribePluginVersion;
