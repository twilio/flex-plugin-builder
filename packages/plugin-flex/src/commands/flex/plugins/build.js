 ...
 */
var FlexPluginsBuild = /** @class */ (function (_super) {
    __extends(FlexPluginsBuild, _super);
    function FlexPluginsBuild() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * @override
     */
    FlexPluginsBuild.prototype.doRun = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        process.env.PERSIST_TERMINAL = 'true';
                        return [4 /*yield*/, this.runScript('pre-script-check')];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.runScript('build')];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Object.defineProperty(FlexPluginsBuild.prototype, "_flags", {
        /**
    ...
    Object.defineProperty(FlexPluginsBuild.prototype, "checkCompatibility", {
        /**
         * @override
         */
        get: function () {
    ...
    FlexPluginsBuild.flags = __assign({}, baseFlags);
    return FlexPluginsBuild;
