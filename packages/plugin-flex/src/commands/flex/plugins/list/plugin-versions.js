 ...
 */
var FlexPluginsListPluginVersions = /** @class */ (function (_super) {
    __extends(FlexPluginsListPluginVersions, _super);
    function FlexPluginsListPluginVersions() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    /**
     * @override
     */
    FlexPluginsListPluginVersions.prototype.getResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pluginsApiToolkit.listPluginVersions({ name: this._flags.name })];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, result.plugin_versions];
                }
            });
        });
    };
    ...
    FlexPluginsListPluginVersions.prototype.notFound = function () {
     ...
     */
    /* istanbul ignore next */
    FlexPluginsListPluginVersions.prototype.print = function (versions) {
        var _this = this;
        var list = this.sortByActive(versions);
        ...
        list.forEach(function (version) {
            _this.printVersion(version.version, version.isActive ? '(Active)' : '');
            _this.printPretty(version, 'isActive', 'pluginSid', 'version');
            _this._logger.newline();
        });
    };
    Object.defineProperty(FlexPluginsListPluginVersions.prototype, "_flags", {
        /**
    ...
    FlexPluginsListPluginVersions.flags = __assign(__assign({}, flex_plugin_1.default.flags), { name: command_1.flags.string({
            description: FlexPluginsListPluginVersions.topic.flags.name,
            required: true,
        }) });
    return FlexPluginsListPluginVersions;
