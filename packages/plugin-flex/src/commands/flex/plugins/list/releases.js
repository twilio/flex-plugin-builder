...
var FlexPluginsListPlugins = /** @class */ (function (_super) {
    ...
    FlexPluginsListPlugins.prototype.getResource = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.pluginsApiToolkit.listReleases({})];
                    case 1:
                        result = _a.sent();
     ...
     */
    /* istanbul ignore next */
    FlexPluginsListPlugins.prototype.print = function (releases) {
        var _this = this;
        releases.forEach(function (release) {
            _this.printVersion(release.sid);
            _this.printPretty(release);
