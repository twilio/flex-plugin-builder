 ...
 */
function archivePluginVersion(pluginVersionsClient) {
    var _this = this;
    return function (options) { return __awaiter(_this, void 0, void 0, function () {
        var pluginVersion;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pluginVersionsClient.archive(options.name, options.version)];
                case 1:
...
exports.default = archivePluginVersion;
//# sourceMappingURL=archivePluginVersion.js.map