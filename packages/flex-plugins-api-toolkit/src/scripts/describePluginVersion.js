 ...
 */
function describePluginVersion(pluginClient, pluginVersionClient, configuredPluginClient, releasesClient) {
    var _this = this;
    return function (option) { return __awaiter(_this, void 0, void 0, function () {
        var resources, _a, plugin, version, release, isActive, installedPlugins;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = __read.apply(void 0, [_b.sent(), 3]), plugin = _a[0], version = _a[1], release = _a[2];
                    isActive = false;
                    if (!release) return [3 /*break*/, 3];
                    return [4 /*yield*/, configuredPluginClient.list(release.configuration_sid)];
                case 2:
                    installedPlugins = (_b.sent()).plugins;
                    isActive = installedPlugins.some(function (p) { return p.plugin_version_sid === version.sid; });
                    _b.label = 3;
...
exports.default = describePluginVersion;
//# sourceMappingURL=describePluginVersion.js.map