 ...
 */
function archiveConfiguration(configurationsClient) {
    var _this = this;
    return function (options) { return __awaiter(_this, void 0, void 0, function () {
        var configuration;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, configurationsClient.archive(options.sid)];
                case 1:
...
exports.default = archiveConfiguration;
//# sourceMappingURL=archiveConfiguration.js.map