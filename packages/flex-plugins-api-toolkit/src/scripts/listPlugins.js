 ...
 */
function listPlugins(pluginsClient, configuredPluginsClient, releasesClient) {
    var _this = this;
    return function (option) { return __awaiter(_this, void 0, void 0, function () {
        var resources, _a, result, release, plugins, list_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    plugins = result.plugins.map(function (plugin) { return ({
                        sid: plugin.sid,
                    ...
                    if (!(release && plugins.length)) return [3 /*break*/, 3];
                ...
                case 2:
                    list_1 = _b.sent();
                    plugins.forEach(function (plugin) { return (plugin.isActive = list_1.plugins.some(function (p) { return p.plugin_sid === plugin.sid; })); });
                    _b.label = 3;
