 ...
 */
function describeRelease(pluginClient, pluginVersionClient, configurationClient, configuredPluginClient, releasesClient) {
    var _this = this;
    return function (option) { return __awaiter(_this, void 0, void 0, function () {
        var resources, release, active, configuration;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    resources = option.resources ? option.resources : {};
                    return [4 /*yield*/, releasesClient.get(option.sid)];
                case 1:
                    release = _a.sent();
                    return [4 /*yield*/, (resources.activeRelease ? Promise.resolve(resources.activeRelease) : releasesClient.active())];
                case 2:
                    active = _a.sent();
                    return [4 /*yield*/, describeConfiguration_1.internalDescribeConfiguration(pluginClient, pluginVersionClient, configurationClient, configuredPluginClient)({ sid: release.configuration_sid }, release)];
                case 3:
...
exports.default = describeRelease;
//# sourceMappingURL=describeRelease.js.map