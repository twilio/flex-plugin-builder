 ...
 */
function archivePlugin(pluginsClient) {
    var _this = this;
    return function (options) { return __awaiter(_this, void 0, void 0, function () {
        var plugin;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, pluginsClient.archive(options.name)];
                case 1:
                    plugin = _a.sent();
                    return [2 /*return*/, {
                            sid: plugin.sid,
...
exports.default = archivePlugin;
//# sourceMappingURL=archivePlugin.js.map