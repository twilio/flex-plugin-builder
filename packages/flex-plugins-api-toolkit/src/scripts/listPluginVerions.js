 ...
 */
function listPluginVersions(pluginVersionsClient, configuredPluginsClient, releasesClient) {
    var _this = this;
    return function (option) { return __awaiter(_this, void 0, void 0, function () {
        var resources, _a, result, release, versions, list_1;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = __read.apply(void 0, [_b.sent(), 2]), result = _a[0], release = _a[1];
                    versions = result.plugin_versions.map(function (version) { return ({
                        sid: version.sid,
                    ...
                    if (!(release && versions.length)) return [3 /*break*/, 3];
                ...
                case 2:
                    list_1 = _b.sent();
                    versions.forEach(function (version) { return (version.isActive = list_1.plugins.some(function (p) { return p.plugin_version_sid === version.sid; })); });
                    _b.label = 3;
...
exports.default = listPluginVersions;
//# sourceMappingURL=listPluginVerions.js.map