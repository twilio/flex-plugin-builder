 ...
 */
function deploy(pluginClient, pluginVersionClient) {
    var _this = this;
    return function (option) { return __awaiter(_this, void 0, void 0, function () {
        var upsertOption, plugin, createOption, version;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, pluginClient.upsert(upsertOption)];
                case 1:
                    plugin = _a.sent();
                    createOption = {
                    ...
                    return [4 /*yield*/, pluginVersionClient.create(plugin.sid, createOption)];
                case 2:
                    version = _a.sent();
                    return [2 /*return*/, {
