 ...
 */
function listReleases(releaseClient) {
    var _this = this;
    return function (option) { return __awaiter(_this, void 0, void 0, function () {
        var result, releases;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, releaseClient.list(option.page)];
                case 1:
                    result = _a.sent();
                    releases = result.releases.map(function (release) { return ({
                        sid: release.sid,
