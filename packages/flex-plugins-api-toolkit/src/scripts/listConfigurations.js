 ...
 */
function listConfigurations(configurationsClient, releasesClient) {
    var _this = this;
    return function (option) { return __awaiter(_this, void 0, void 0, function () {
        var resources, _a, result, release, configurations;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    configurations = result.configurations.map(function (configuration) { return ({
...
exports.default = listConfigurations;
//# sourceMappingURL=listConfigurations.js.map