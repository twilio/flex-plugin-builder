...
var testSuite = function (params) { return __awaiter(void 0, void 0, void 0, function () {
    var result, release, plugins;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, utils_1.spawn('twilio', [
            ...
            case 3:
                plugins = _a.sent();
                utils_1.assertion.stringContains(result.stdout, 'successful');
                utils_1.assertion.stringContains(result.stdout, 'Configuration FJ');
                utils_1.assertion.stringContains(result.stdout, 'enabled');
                utils_1.assertion.equal(1, plugins.plugins.length);
                utils_1.assertion.equal(plugins.plugins[0].unique_name, params.plugin.name);
                utils_1.assertion.equal(plugins.plugins[0].version, params.plugin.version);
                return [2 /*return*/];
        }
    });
}); };
